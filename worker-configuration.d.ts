// Generated by Wrangler by running `wrangler types` (hash: 9146f0febf03e7acc75e1f1148a43228)
// Runtime types generated with workerd@1.20250310.0 2025-08-11 
interface Env {
	...
	RESEARCH_ORCH: DurableObjectNamespace<import("./src/index").ResearchOrchestrator>;
	PR_WORKFLOWS: DurableObjectNamespace<import("./src/index").PrWorkflow>;
	PROFILE_SCANNER: DurableObjectNamespace<import("./src/index").ProfileScanner>;
	DB: D1Database;
	AI: Ai;
}
